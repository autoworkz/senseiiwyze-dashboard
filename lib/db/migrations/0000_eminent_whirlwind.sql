...
--> statement-breakpoint
CREATE UNIQUE INDEX `invitation_organizationId_email_unique` ON `invitation` (`organizationId`,`email`);--> statement-breakpoint
CREATE TABLE `member` (
	`id` text PRIMARY KEY NOT NULL,
	`organizationId` text NOT NULL,
	`userId` text NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `member_userId_organizationId_unique` ON `member` (`userId`,`organizationId`);--> statement-breakpoint
