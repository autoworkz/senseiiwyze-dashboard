import { pgSchema, pgTable, text, uuid, varchar, jsonb, timestamp, uniqueIndex, foreignKey, smallint, boolean, bigint, integer, unique, json, doublePrecision, index, serial, pgPolicy, check, numeric, inet, primaryKey, pgView, pgSequence, pgEnum } from "drizzle-orm/pg-core"
import { sql } from "drizzle-orm"

export const appSchema = pgSchema("auth");
